    ...
    <div className="flex flex-col flex-1 items-center justify-center min-h-[85vh] bg-slate-50 px-4 py-12">
      <div className="w-full max-w-md bg-white rounded-xl shadow-md border border-slate-100 p-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Join the community coordination network</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <span className="block text-sm font-medium text-slate-700 mb-2">Select your role</span>
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <input
                  ...
                  className="sr-only"
                />
                <span className="text-sm font-medium text-slate-900">Affected Individual</span>
                <span className="text-xs text-slate-500 mt-1">Needs resource support</span>
              </label>
              ...
              >
                <input
                  ...
                  className="sr-only"
                />
                <span className="text-sm font-medium text-slate-900">Volunteer</span>
                <span className="text-xs text-slate-500 mt-1">Offers resource support</span>
              </label>
            </div>
          </div>
